 ...
 */
public class EmittableByteArrayOutputStream extends ByteArrayOutputStream implements Emittable, LineOutputCallback, IRCOutput {
    ...
    public void emit(final IRCOutput output) throws IOException {
