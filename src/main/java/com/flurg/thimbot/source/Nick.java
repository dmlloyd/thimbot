...
import static com.flurg.thimbot.IRCStrings.NOTICE;
import static com.flurg.thimbot.IRCStrings.PRIVMSG;
 ...
 */
public class Nick implements FullTarget {
    ...
    public Preferences getPreferences(final Preferences ourRoot) {
        return ourRoot.node("user").node("default");
    }
    ...
    public boolean equals(Object other) {
        return other instanceof Nick && equals((Nick)other);
    }
     ...
     * @return {@code true} if they are equal, {@code false} otherwise
     */
    public boolean equals(Nick other) {
