 ...
 *
 */
public final class NewMessageEvent extends NewProtocolCommandEvent {

    public NewMessageEvent(final String source, final String rawMessage, final List<String> targets, final boolean outbound) {
    ...
    public void writeCommand(final TextBuffer output, final List<String> targets) {
        ...
        output.append("PRIVMSG ");
        appendTargets(output, getTargets(), ',');
        output.append(" :");
