 ...
 */
public final class OutboundServerPingEvent extends AbstractTextEvent implements OutboundEvent, TextEvent {
    private final Priority priority;

    public OutboundServerPingEvent(final ThimBot bot, final Priority priority, final String payload) {
        super(bot, payload);
