 ...
 */
public final class CapabilityEndEvent extends AbstractEvent implements OutboundProtocolEvent {

    private final Priority priority;

    public CapabilityEndEvent(final ThimBot bot, final Priority priority) {
        super(bot);
