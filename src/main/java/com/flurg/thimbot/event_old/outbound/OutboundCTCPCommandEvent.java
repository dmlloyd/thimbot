 ...
 */
public final class OutboundCTCPCommandEvent extends AbstractEvent implements OutboundEvent, MultiTargetEvent {
    private final Priority priority;
    private final Set<String> targets;
    private final String command;
    private final String argument;

    public OutboundCTCPCommandEvent(final ThimBot bot, final Priority priority, final Set<String> targets, final String command, final String argument) {
        super(bot);
