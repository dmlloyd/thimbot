 ...
 */
public final class OutboundBackRequestEvent extends AbstractEvent implements OutboundEvent {

    private final Priority priority;

    public OutboundBackRequestEvent(final ThimBot bot, final Priority priority) {
        super(bot);
