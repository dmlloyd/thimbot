 ...
 */
public final class IRCUserEvent extends AbstractEvent implements OutboundEvent {

    private final String userName;
    private final String realName;
    private final Priority priority;

    public IRCUserEvent(final ThimBot bot, final Priority priority, final String userName, final String realName) {
        super(bot);
