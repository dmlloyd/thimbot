 ...
 */
public final class NickChangeRequestEvent extends AbstractEvent implements OutboundEvent {

    private final String newNick;
    private final Priority priority;

    public NickChangeRequestEvent(final ThimBot bot, final Priority priority, final String newNick) {
        super(bot);
