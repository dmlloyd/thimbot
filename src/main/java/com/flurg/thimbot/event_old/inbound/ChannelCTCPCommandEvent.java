 ...
 */
public final class ChannelCTCPCommandEvent extends AbstractEvent implements FromUserEvent, ChannelEvent, InboundEvent {
    ...
    public ChannelCTCPCommandEvent(final ThimBot bot, final String user, final String channel, final String command, final String argument) {
        super(bot);
        this.user = user;
