...
/**
 * An event indicating that the read side of the connection has hung up.
 *
 * @author <a href="mailto:david.lloyd@redhat.com">David M. Lloyd</a>
 */
public final class HangUpEvent extends AbstractEvent implements InboundEvent {

    public HangUpEvent(final ThimBot bot) {
        super(bot);
    }
