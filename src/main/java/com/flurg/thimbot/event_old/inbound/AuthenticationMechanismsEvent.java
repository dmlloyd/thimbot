 ...
 */
public final class AuthenticationMechanismsEvent extends AbstractTextEvent implements InboundEvent, TextEvent {
    private final List<String> mechanisms;

    public AuthenticationMechanismsEvent(final ThimBot bot, final List<String> mechanisms, final String rawMessage) {
