 ...
 */
public final class LoggedOutEvent extends AbstractTextEvent implements InboundEvent, TextEvent {

    public LoggedOutEvent(final ThimBot bot, final String rawMessage) {
