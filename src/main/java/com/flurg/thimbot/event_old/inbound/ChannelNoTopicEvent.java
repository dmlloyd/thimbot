 ...
 */
public final class ChannelNoTopicEvent extends AbstractEvent implements ChannelEvent, InboundEvent {
    private final String channel;

    public ChannelNoTopicEvent(final ThimBot bot, final String channel) {
        super(bot);
