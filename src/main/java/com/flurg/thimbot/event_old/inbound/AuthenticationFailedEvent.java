 ...
 */
public final class AuthenticationFailedEvent extends AbstractTextEvent implements InboundEvent, TextEvent {

    public AuthenticationFailedEvent(final ThimBot bot, final String rawMessage) {
