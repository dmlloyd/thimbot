 ...
 */
public final class LoggedInEvent extends AbstractTextEvent implements InboundEvent, TextEvent {

    public LoggedInEvent(final ThimBot bot, final String rawMessage) {
