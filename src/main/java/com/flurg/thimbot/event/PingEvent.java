 ...
 */
public final class PingEvent extends Event implements Event.From<User>, Event.To<FullTarget> {
    private final User source;
    private final FullTarget target;
    private final String payload;

    public PingEvent(final ThimBot bot, final User source, final FullTarget target, final String payload) {
        super(bot);
        this.source = source;
        this.target = target;
