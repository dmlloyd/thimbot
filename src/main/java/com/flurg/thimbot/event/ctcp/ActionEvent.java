...
/**
 */
public final class ActionEvent extends CtcpCommandEvent {
    public ActionEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public ActionEvent clone() {
        return (ActionEvent) super.clone();
    }
}
