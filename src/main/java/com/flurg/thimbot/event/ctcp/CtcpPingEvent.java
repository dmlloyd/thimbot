...
/**
 */
public final class CtcpPingEvent extends CtcpCommandEvent {
    public CtcpPingEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public CtcpPingEvent clone() {
        return (CtcpPingEvent) super.clone();
    }
}
