...
/**
 */
public final class CtcpTimeEvent extends CtcpCommandEvent {
    public CtcpTimeEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public CtcpTimeEvent clone() {
        return (CtcpTimeEvent) super.clone();
    }
}
