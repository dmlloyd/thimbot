...
/**
 */
public final class CtcpVersionEvent extends CtcpCommandEvent {
    public CtcpVersionEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public CtcpVersionEvent clone() {
        return (CtcpVersionEvent) super.clone();
    }
}
