 ...
 */
public final class CTCPResponseEvent extends Event implements Event.From<User>, Event.To<FullTarget> {
    private final User source;
    private final FullTarget target;
    private final String command;
    private final String argument;

    public CTCPResponseEvent(final ThimBot bot, final User source, final FullTarget target, final String command, final String argument) {
        super(bot);
        this.source = source;
        this.target = target;
