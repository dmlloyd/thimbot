...
/**
 */
public final class CapListActiveEvent extends CapEvent {

    public CapListActiveEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public CapListActiveEvent clone() {
        return (CapListActiveEvent) super.clone();
    }
}
