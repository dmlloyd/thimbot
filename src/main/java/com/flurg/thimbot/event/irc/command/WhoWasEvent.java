...
/**
 */
public final class WhoWasEvent extends IrcCommandEvent {
    private int count;
    private String serverPattern;

    public WhoWasEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public WhoWasEvent clone() {
        return (WhoWasEvent) super.clone();
    }
