...
/**
 */
public final class KickEvent extends IrcCommandEvent {
    public KickEvent(final boolean outbound, final String source, final List<String> targets) {
