...
/**
 */
public final class ServerPongEvent extends IrcCommandEvent {
    public ServerPongEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public ServerPongEvent clone() {
        return (ServerPongEvent) super.clone();
    }
}
