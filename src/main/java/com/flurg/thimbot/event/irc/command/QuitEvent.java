...
/**
 */
public final class QuitEvent extends IrcCommandEvent {
    public QuitEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public QuitEvent clone() {
        return (QuitEvent) super.clone();
    }
}
