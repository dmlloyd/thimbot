...
/**
 */
public final class PassEvent extends IrcCommandEvent {
    public PassEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public PassEvent clone() {
        return (PassEvent) super.clone();
    }
}
