...
/**
 */
public final class AcceptEvent extends IrcCommandEvent {
    public AcceptEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public AcceptEvent clone() {
        return (AcceptEvent) super.clone();
    }
}
