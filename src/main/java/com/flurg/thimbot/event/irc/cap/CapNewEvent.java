...
/**
 */
public final class CapNewEvent extends CapEvent {

    public CapNewEvent(final String source, final List<String> targets) {
        super(false, source, targets, new ArrayList<>());
    }
    ...
    public CapNewEvent clone() {
        return (CapNewEvent) super.clone();
    }
}
