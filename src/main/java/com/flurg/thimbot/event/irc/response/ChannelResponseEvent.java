...
/**
 */
public class ChannelResponseEvent extends ResponseEvent {
    private final String channel;

    public ChannelResponseEvent(final String source, final int code, final String channel) {
        super(source, code);
    ...
    public ChannelResponseEvent clone() {
        return (ChannelResponseEvent) super.clone();
    }
}
