...
/**
 */
public final class WhoIsEvent extends IrcCommandEvent {
    private String serverPattern;

    public WhoIsEvent(final boolean outbound, final String source, final List<String> targets) {
