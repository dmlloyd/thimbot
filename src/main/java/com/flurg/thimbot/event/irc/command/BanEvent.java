...
/**
 */
public final class BanEvent extends IrcCommandEvent {
    public BanEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public BanEvent clone() {
        return (BanEvent) super.clone();
    }
}
