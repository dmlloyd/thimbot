...
/**
 */
public final class JoinEvent extends IrcCommandEvent {
    private String accountName;

    public JoinEvent(final boolean outbound, final String source, final List<String> targets) {
