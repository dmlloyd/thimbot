...
/**
 */
public final class UserEvent extends IrcCommandEvent {

    public UserEvent(final String nickName, final boolean flag1, final boolean flag2, final String realName) {
