...
/**
 */
public final class TopicEvent extends IrcCommandEvent {
    public TopicEvent(final boolean outbound, final String source, final List<String> targets) {
