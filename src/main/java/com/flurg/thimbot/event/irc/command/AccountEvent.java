...
/**
 */
public final class AccountEvent extends IrcCommandEvent {
    private String accountName;

    public AccountEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public AccountEvent clone() {
        return (AccountEvent) super.clone();
    }
