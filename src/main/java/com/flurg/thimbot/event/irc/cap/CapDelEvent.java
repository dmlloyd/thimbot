...
/**
 */
public final class CapDelEvent extends CapEvent {

    public CapDelEvent(final String source, final List<String> targets) {
    ...
    public CapDelEvent clone() {
        return (CapDelEvent) super.clone();
    }
}
