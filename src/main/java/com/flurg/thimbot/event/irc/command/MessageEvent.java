...
/**
 */
public final class MessageEvent extends IrcCommandEvent {
    public MessageEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    protected void addToString(final StringBuilder b) {
        if (getDecodedText().regionMatches(true, 0, "IDENTIFY ", 0, 9)) {
            b.append("IDENTIFY ••••••••••••");
        } else {
            super.addToString(b);
        }
