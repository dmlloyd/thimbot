...
package com.flurg.thimbot.event.irc;
...
public abstract class ProtocolEvent extends Event {
    protected ProtocolEvent(final boolean outbound, final String source, final List<String> targets) {
        super(outbound, source, targets);
    }

    public ProtocolEvent clone() {
        return (ProtocolEvent) super.clone();
    }
}
