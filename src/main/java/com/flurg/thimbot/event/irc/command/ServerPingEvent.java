...
/**
 */
public final class ServerPingEvent extends IrcCommandEvent {
    public ServerPingEvent(final boolean outbound, final String source, final List<String> targets) {
    ...
    public ServerPingEvent clone() {
        return (ServerPingEvent) super.clone();
    }
}
