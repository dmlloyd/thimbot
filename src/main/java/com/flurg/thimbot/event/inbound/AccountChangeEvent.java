 ...
 */
public final class AccountChangeEvent extends AbstractEvent implements InboundEvent, FromUserEvent {
    ...
    public AccountChangeEvent(final ThimBot bot, final String user, final String accountName) {
        super(bot);
        this.user = user;
