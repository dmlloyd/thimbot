 ...
 */
public final class ChannelCTCPResponseEvent extends AbstractEvent implements FromUserEvent, ChannelEvent, InboundEvent {
    ...
    public ChannelCTCPResponseEvent(final ThimBot bot, final String user, final String channel, final String command, final String argument) {
        super(bot);
        this.user = user;
