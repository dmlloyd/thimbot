 ...
 */
public final class PrivateCTCPResponseEvent extends AbstractEvent implements FromUserEvent, InboundEvent {
    ...
    public PrivateCTCPResponseEvent(final ThimBot bot, final String user, final String command, final String argument) {
        super(bot);
        this.user = user;
