 ...
 */
public final class PrivateMessageEvent extends AbstractTextEvent implements InboundEvent, FromUserEvent, TextEvent, MessageRespondableEvent {

    private final String nick;
    private final String user;
    private final boolean fromMe;

    public PrivateMessageEvent(final ThimBot bot, final String user, final String rawMessage) {
